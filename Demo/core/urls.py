...
from core.views import index, perro, gato, perro1, perro2, perro3, perro4, perro5 , gato1, gato2, gato3, gato4, gato5, nosotros, contacto,agregarPerro,añadirPerro,FormularioModPerro,modificarPerro
